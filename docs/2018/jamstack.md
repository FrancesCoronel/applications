...
Also, just in general, I'm a HUGE fan of the JAMstack - I use Hugo (one of the more popular static site generators as you're probably well aware) and it scores a perfect score of 100 with Lighthouse (except performance which is a 99). See https://francescoronel.com/colophon.

I even applied to the hackathon happening the weekend prior https://hackathon.freecodecamp.org/ and you can check out the little Gatsby website I made for the hackathon application: http://jamstack-hackathon.francescoronel.com/.
